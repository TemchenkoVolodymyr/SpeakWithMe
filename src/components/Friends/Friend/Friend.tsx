    ...
    <>
       <div className={style.wrapperItem}>
          ...
          <div className={style.wrapperImage}>
             ...
             {subscribers?.subscribedFriendsId.find((sub : any)  => sub === user._id ) ? <button className={style.unsubStyle} onClick={() => subscribe(user._id)}>Unfollow</button> : <button className={style.subStyle} onClick={() => subscribe(user._id)}>Follow</button>}
          </div>
