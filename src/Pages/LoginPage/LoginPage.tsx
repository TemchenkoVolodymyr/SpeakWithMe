...
export const LoginPage = () => {
   ...
   const createNewUser = (email : string, name : string, password : string, confirmPassword : string,photo:any,socialNetwork:any) => {
      dispatch<any>(createUserThunkCreator(email,name,password,confirmPassword,navigate , photo , socialNetwork))
   }

   const login = (email : string, password : string) => {
      dispatch<any>(loginUserThunkCreator(email,password,navigate))
   }
